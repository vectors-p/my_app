...
mixin _$WeatherModel {
 ...
 String get city; String get country; double get temperature; double get feelsLike; double get tempMin; double get tempMax; String get description; int get weatherCode; int get humidity; double get windSpeed; int get pressure; bool get isDay; String get time;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,city,country,temperature,feelsLike,tempMin,tempMax,description,weatherCode,humidity,windSpeed,pressure,isDay,time);

@override
String toString() {
  return 'WeatherModel(city: $city, country: $country, temperature: $temperature, feelsLike: $feelsLike, tempMin: $tempMin, tempMax: $tempMax, description: $description, weatherCode: $weatherCode, humidity: $humidity, windSpeed: $windSpeed, pressure: $pressure, isDay: $isDay, time: $time)';
}
...
@useResult
$Res call({
 String city, String country, double temperature, double feelsLike, double tempMin, double tempMax, String description, int weatherCode, int humidity, double windSpeed, int pressure, bool isDay, String time
});
...
switch (_that) {
case _WeatherModel() when $default != null:
return $default(_that.city,_that.country,_that.temperature,_that.feelsLike,_that.tempMin,_that.tempMax,_that.description,_that.weatherCode,_that.humidity,_that.windSpeed,_that.pressure,_that.isDay,_that.time);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String city,  String country,  double temperature,  double feelsLike,  double tempMin,  double tempMax,  String description,  int weatherCode,  int humidity,  double windSpeed,  int pressure,  bool isDay,  String time)  $default,) {final _that = this;
switch (_that) {
case _WeatherModel():
return $default(_that.city,_that.country,_that.temperature,_that.feelsLike,_that.tempMin,_that.tempMax,_that.description,_that.weatherCode,_that.humidity,_that.windSpeed,_that.pressure,_that.isDay,_that.time);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String city,  String country,  double temperature,  double feelsLike,  double tempMin,  double tempMax,  String description,  int weatherCode,  int humidity,  double windSpeed,  int pressure,  bool isDay,  String time)?  $default,) {final _that = this;
switch (_that) {
case _WeatherModel() when $default != null:
return $default(_that.city,_that.country,_that.temperature,_that.feelsLike,_that.tempMin,_that.tempMax,_that.description,_that.weatherCode,_that.humidity,_that.windSpeed,_that.pressure,_that.isDay,_that.time);case _:
  return null;
